...
const tourSchema = new mongoose.Schema(
  {
    ...
    difficulty: {
      ...
      enum: {
        ...
        message: 'Difficutly is either easy, medium and difficult',
      },
    },
    ratingsAverage: {
      type: Number,
      default: 4.5,
      min: [1, 'A rating average cannot be lower than 1'],
      max: [5, 'A rating average cannot be higher than 5'],
...
// create an index in the db so at the search with a filter obj, it will take less documents to get the specifed results
