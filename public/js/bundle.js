...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiY2xpbCIsImEiOiJja3d4aDM4YTkwZHRqMm9tbno4bGM1NzN1In0.bCOJXx0e40eSF3FZhxeRHg';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type === 'data' ? 'Data' : 'Password', " Updated"));
            }
...
function _forgotPassword() {
  _forgotPassword = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(email) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'A mail sent into your inbox with the link to reset your password');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var stripe = Stripe('pk_test_51K6CZoGuTkj7NYP9o5xIXPnXOgpblFAac8PO25aIkdFhHqdoaDZldPQMBDl8H91N9QEkVTk2BEAX7RpbyyhzbHtZ00L6mh8OFJ');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); //2)create checkoutform + chagre the credit card
